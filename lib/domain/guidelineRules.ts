...
export const GUIDELINE_RULES: GuidelineRule[] = [
  ...
  {
    id: "nice-ng253-infection-delirium-001",
    title: "Infection with acute confusion pattern",
    sourceBody: "NICE",
    sourceId: "NG253",
    sourceCoverage: "partial",
    rationale:
      "Acute confusion with fever, infection source, or abnormal physiology should keep infection and sepsis actively in view while the precipitant is sought.",
    triggers: [
      "confusion",
      "drowsiness",
      "fever",
    ...
    boostDiagnoses: ["Delirium secondary to infection", "Sepsis", "UTI / urosepsis", "Pneumonia"],
    requiredAnyFeatures: ["fever", "rigors", "infection_source", "urinary_symptoms", "productive_cough", "crackles", "hypoxia"],
  },
  {
