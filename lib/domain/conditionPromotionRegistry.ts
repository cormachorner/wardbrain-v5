...
export const CONDITION_PROMOTION_REGISTRY: WardBrainConditionPromotionEntry[] = [
  ...
  {
    canonicalName: "Medication / sedative toxicity",
    presentationFamilies: ["confusion-delirium"],
    promotionStatus: LIVE_ENGINE,
    aliases: [
      "medication toxicity",
    ...
    notes: "Confusion/delirium v1 comparator for medication-related altered mental state.",
    learnMoreKey: "medication-sedative-toxicity",
  },
  {
    canonicalName: "Alcohol withdrawal",
    presentationFamilies: ["confusion-delirium"],
    promotionStatus: LIVE_ENGINE,
    aliases: ["alcohol withdrawal", "delirium tremens", "withdrawal delirium"],
    notes: "Confusion/delirium v1 comparator for withdrawal-related altered mental state.",
    learnMoreKey: "alcohol-withdrawal",
  },
  {
    canonicalName: "Electrolyte / metabolic disturbance",
    presentationFamilies: ["confusion-delirium"],
    promotionStatus: LIVE_ENGINE,
    aliases: ["electrolyte disturbance", "metabolic disturbance", "hyponatraemia", "hyponatremia"],
    notes: "Confusion/delirium v1 comparator for metabolic or electrolyte-driven altered mental state.",
    learnMoreKey: "electrolyte-metabolic-disturbance",
  },
  {
    canonicalName: "Dementia / chronic cognitive impairment",
    presentationFamilies: ["confusion-delirium"],
    promotionStatus: LIVE_ENGINE,
    aliases: ["dementia", "baseline dementia", "chronic cognitive impairment"],
    notes: "Comparator only; acute deterioration should still promote delirium or another acute cause.",
    learnMoreKey: "dementia-chronic-cognitive-impairment",
  },
  {
