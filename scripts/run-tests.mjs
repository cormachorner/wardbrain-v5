...
run("./node_modules/.bin/tsc", [
  ...
  "lib/domain/labs/labEvidenceDisplay.ts",
  ...
  "lib/input/labTextParser.ts",
  "lib/input/smartCaseInput.ts",
  ...
  "lib/llm/presentationFactsBuilder.ts",
  "lib/llm/presentationRewrite.ts",
  ...
  "tests/biochemicalManualFixes.test.mts",
  ...
  "tests/presentationFactsBuilder.test.mts",
  "tests/presentationRewriteEval.test.mts",
...
run("node", [
  ...
  join(buildDir, "tests", "biochemicalManualFixes.test.mjs"),
  ...
  join(buildDir, "tests", "presentationFactsBuilder.test.mjs"),
  join(buildDir, "tests", "presentationRewriteEval.test.mjs"),
